...
## 📋 3. Quy chuẩn viết tài liệu → `doc_standards.md`

Đọc `doc_standards.md` (cùng thư mục) khi cần chuẩn viết Feature Spec, API Spec, Test Suite, Test Case, hoặc Feature Group.

---

## 📄 4. Các file điều khiển → `control_files.md`

Đọc `control_files.md` (cùng thư mục) khi cần cú pháp KANBAN, format log, Changelog, Git convention, hoặc Update Propagation Checklist.
